...
9. Test if sockshop deployed succesfully:
sudo python -u run_experiment.py --use_k3s_cluster --no_exfil --config_file ../sockshop_experiment.json --localhostip 127.0.0.1 --localport 30001 | tee sockshop_four_140.log
